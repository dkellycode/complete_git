...
farmfiles<-list.files("\\\\10.103.128.1\\PropellaEDI\\live\\Orders to import",pattern = "^FS CPSL Orders")
aciemfiles<-list.files("\\\\10.103.128.1\\PropellaEDI\\live\\Orders to import",pattern = "^Order_")
smartfiles<-list.files("\\\\10.103.128.1\\PropellaEDI\\live\\Orders to import",pattern = "^SL CPSL Orderst")
biwfiles<-list.files("\\\\10.103.128.1\\PropellaEDI\\live\\Orders to import",pattern = "^BIPO")
pggfiles<-list.files("\\\\10.103.128.1\\PropellaEDI\\live\\Orders to import",pattern = "^CPS \\d{2}")
isl1files<-list.files("\\\\10.103.128.1\\PropellaEDI\\live\\Orders to import",pattern = "^CPSL-Orders-from-ISL")
isl2files<-list.files("\\\\10.103.128.1\\PropellaEDI\\live\\Orders to import",pattern = "^ISLPO\\d{6}")
islfiles<-c(isl1files,isl2files)
imlfiles<-list.files("\\\\10.103.128.1\\PropellaEDI\\live\\Orders to import",pattern = "^IML GROUP")
simefiles<-list.files("\\\\10.103.128.1\\PropellaEDI\\live\\Orders to import",pattern = "^\\d{7}")
viridianfiles<-list.files("\\\\10.103.128.1\\PropellaEDI\\live\\Orders to import",pattern = "^\\w{7,10} CPS Orders")
...
filecount<-length(list.files("\\\\10.103.128.1\\PropellaEDI\\live\\Orders to import", full.names = TRUE)%>%.[!file.info(.)$isdir])
...
# Rearrange the table 
impsmart<-smart[c(2,19,1,17,6,10,11,20,12,13,9,21,15,18,3,16)]
...
fwrite(xxxxx,file = "I:\\live\\Orders to import\\Import Files\\importbuilder.csv", sep= ",",col.names = !file.exists("importbuilder.csv"), row.names = FALSE, append = TRUE)